      ...
      <div className="container">
        ...
        <section>
          ...
          <div className="home__direction">
            ...
            <div className="home__direction-description">
              ...
              <div className="home__direction-lebed">
                <div className="home__direction-pacha">
                  <img src={gusto} alt="lama" />
                </div>
          ...
          <p className="home__direction-text text">
            ...
            Мы сосредотачиваемся на поддержке семей, стараемся создавать
            семейные форматы мероприятий и условия для счастливой и здоровой
            жизни всех членов семьи. Мы предоставляем семьям информацию и
            образовательные программы по решению важных вопросов в сфере
            здравоохранения, образования и воспитания детей.
          </p>
          <p className="home__direction-text text">
            <strong>- Общественные экологические инициативы. </strong>В
            партнерстве с Центром развития экологических и социальных проектов
            «Крышечки ДоброТЫ» наши волонтеры на регулярной основе организуют
            сбор перерабатываемых отходов.
          </p>
          <img
            className="home__image home__image--puma "
            src={puma}
            alt="puma"
          />
        </section>
        ...
        <section>
          <div className="home__volonters">
            ...
            <div className="home__volonters-image">
              ...
              <div className="home__volonters-mobile">
          ...
          <div className="home__volonters-description">
            ...
            <p className="text">
              Объединяет семьи в дружные сообщества, чтобы{" "}
              <strong className="text__strong">
                учиться друг у друга быть счастливыми в семье
              </strong>{" "}
              долгие годы.
            </p>
          </div>
          <img className="home__dushamoloda" src={dushaMoloda} alt="" />
          <div className="home__volonters-description home__volonters-description--margin">
            <p className="text text--lg">
              <strong>Отряд Серебряных волонтеров «Молоды душой»</strong>
              от региональной общественной организации социального центра
              «Диалог поколений».
            </p>
            <p className="text ">
              Миссия —{" "}
              <strong className="text__strong">
                смягчение социальной напряженности в обществе
              </strong>
              , создание условий для общения, самореализации и актуализации
              граждан разных поколений.
            </p>
          </div>
