      ...
      <div className="subscribe__paragraph">
        <p className="text">
          ...
          <a href="#">
            ...
            <br className="home__br-mobile" /> персональных данных.
          </a>
        </p>
        <p className="text">
          Вы также можете узнавать наши новости из группы Вконтакте. Мы
          регулярно <br className="home__br-mobile" /> обновляем нашу ленту
          новостей, радуя подписчиков новыми интересными публикациями.
        </p>
      </div>
